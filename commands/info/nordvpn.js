module.exports = {
    name: "nordvpn",
    description: "gives you nordvpn accounts",
    run: async (client, message, args) => {
      message.channel.send({ embed: { author: { name: "🚀 NordVpn Account sent in DMs!" }, color: 0x7289DA }})
var string = `priyamshah95@gmail.com:chikoo40
...
josef.bremberger@pruned_27591848.com:Avalanche123
